...
export const defaultWalletActionsConfig: INetworkWalletActionsConfig = {
  ...
  // More menu: swap first, then bind virtual card + withdraw + copy + explorer.
  moreActions: ['swap', 'bindVirtualCard', 'sell', 'copy', 'explorer'],
  moreActionGroups: [
    {
      type: 'tools',
      actions: ['swap', 'bindVirtualCard', 'sell', 'copy', 'explorer'],
      order: 1,
    },
  ],
};
